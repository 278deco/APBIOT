 ...
 * 
 */
public enum BaseCoreModuleType implements CoreModuleType {
	...
	private BaseCoreModuleType(String name, int ordering) {
		this.name = name;
		this.mandatory = false;
		this.ordering = ordering;
	}
	
	private BaseCoreModuleType(String name, int ordering, boolean mandatory) {
		this.name = name;
