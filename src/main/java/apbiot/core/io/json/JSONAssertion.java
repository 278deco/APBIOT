...
public class JSONAssertion {
	...
	public static void assertTrue(boolean condition, String testedKey) {
		if (!condition)
			throw new JSONAssertionException("Boolean condition wasn't met", testedKey, AssertionType.NOT_EQUAL);
	}

	public static void assertTrue(boolean condition) {
		if (!condition)
			throw new JSONAssertionException("Boolean condition wasn't met", AssertionType.NOT_EQUAL);
	}
